...
- Four python MQTT bridges which translate the indi and ratsche messages into an MQTT telemetry stream and vice versa (indi->MQTT, MQTT->indi, ratsche->MQTT and MQTT->ratsche)
